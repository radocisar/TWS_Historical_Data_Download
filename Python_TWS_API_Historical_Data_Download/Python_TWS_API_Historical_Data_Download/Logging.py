...
class Logging:
    ...
    File_Location = r"{}:\Raw_Data\Raw_1_sec_Bar_Data\US_Stocks_Log\{}_US_Stocks.log".format(Drive_to_Save_Files_to.Drive_Function_Class.Drive_Function.Drive, Current_Date)
    ...
    def Date_Updater(self):
        while True:
            ...
            self.File_Location = r"{}:\Raw_Data\Raw_1_sec_Bar_Data\US_Stocks_Log\{}_US_Stocks.log".format(Drive_to_Save_Files_to.Drive_Function_Class.Drive_Function.Drive, self.Current_Date)
